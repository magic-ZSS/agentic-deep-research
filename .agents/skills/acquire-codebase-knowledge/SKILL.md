...
## Local Output Language Override

When using this skill in this repository, all generated documentation must be written in Simplified Chinese.

Requirements:

- All files under docs/codebase/ must use Simplified Chinese.
- Keep technical terms in English when necessary, and add short Chinese explanations when helpful.
- File names may remain English, for example:
  - STACK.md
  - STRUCTURE.md
  - ARCHITECTURE.md
  - CONVENTIONS.md
  ...
  - TESTING.md
  - CONCERNS.md
- Do not translate code, commands, package names, API names, class names, function names, file paths, environment variable names, or configuration keys.
- Prefer compact Chinese technical writing.
- Avoid long generic explanations.
- Focus on helping the user quickly understand the project structure, architecture, runtime flow, test/validation commands, and risks.
- If the original skill asks for English documentation, this local override takes priority.
